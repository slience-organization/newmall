...
<script>
  ...
  export default {
    ...
    updated() {
      //console.log(this.$refs.detailBaseInfo.$el.offsetTop)
      //console.log(this.$refs.detailShopInfo.$el.offsetTop)
      //console.log(this.$refs.detailGoodsInfo.$el.offsetTop)
